...
V-Note's desktop widget provides quick access to transcription controls without interrupting your workflow.
...
You can customize the widget in the V-Note preferences:
